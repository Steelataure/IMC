    ...
    <div class="container mx-auto p-8">
        ...
        <form action="/simulateur" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" step="0.01" name="weight" id="weight" class="border border-gray-400 p-2 w-full" required>
            </div>
            <div class="mb-4">
                <label for="height" class="block text-gray-700 font-semibold mb-2">Taille (cm)</label>
                <input type="number" step="0.01" name="height" id="height" class="border border-gray-400 p-2 w-full" required>
            </div>
